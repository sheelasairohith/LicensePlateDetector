...
def recognize_plate(img, coords):
    ...
    plate_num = ""
    #print(pytesseract.image_to_string(cv2.medianBlur(im2, 5)))
    ...
    for cnt in sorted_contours:
        ...
        #text = pytesseract.image_to_string(roi, config='-c tessedit_char_whitelist=0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ --psm 6 --oem 4')
        #print(text)
